...
import { Shimmer, ShimmerStatTile } from '../../components/ui/Shimmer';
import {
...
export default function AdminDashboardPage() {
  ...
  return (
    <AdminLayout
      ...
      subtitle="Operational snapshot of the branch"
      actions={
    ...
    >
      <div className="admin-stat-grid">
        {loading ? (
          ...
          <>
            ...
            <StatTile icon={IconCheckCircle} label="Revenue this FY" value={fmtINR(stats?.revenue_fy_paise)} />
          </>
        )}
      </div>
      ...
      <style>{`
        ...
        .admin-event-row:hover { background: var(--muted, #fafaf9); }
